...
public interface DynamicDataApi {
    ...
    default ResponseEntity<Void> base64ValueGet(
    ...
    default ResponseEntity<Void> bytesNGet(
    ...
    default ResponseEntity<Void> rangeNumbytesGet(
    ...
    default ResponseEntity<Void> streamNGet(
        @Parameter(name = "n", description = "", required = true, in = ParameterIn.PATH) @PathVariable("n") Integer n
    ) throws Exception {
        return new ResponseEntity<>(HttpStatus.NOT_IMPLEMENTED);
